        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="sm:hidden shrink-0 flex items-center">
                    <a href="{{ route('transaction.index') }}" class="uppercase text-gray-800 dark:text-white font-medium">
                        {{ Auth::user()->name }}
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-0 sm:flex">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-teal-500 dark:bg-teal-800 hover:text-gray-100 dark:hover:text-white focus:outline-none transition ease-in-out duration-150">
